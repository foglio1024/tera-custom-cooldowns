...
namespace TeraPacketParser.Messages
{
    public class S_FRIEND_LIST : ParsedMessage
    {
        ...
        public S_FRIEND_LIST(TeraMessageReader reader) : base(reader)
        {
            ...
            var personalNotePtr = reader.ReadUInt16();
        ...
        private FriendEntry ParseFriend(TeraMessageReader reader)
        {
            ...
            var myNotePtr = reader.ReadUInt16();
            var theirNotePtr = reader.ReadUInt16();
