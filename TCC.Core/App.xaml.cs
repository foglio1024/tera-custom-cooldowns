...
#pragma warning restore CS0162
        ...
        private static void DebugStuff()
        {
            ...
            //(WindowManager.ClassWindow.VM.CurrentManager as WarriorLayoutVM).DeadlyGamble.Cooldown.Start(2000);
            ...
            */
            ...
            //Task.Delay(1000).ContinueWith(t => (WindowManager.ClassWindow.VM.CurrentManager as WarriorLayoutVM).DeadlyGamble.Buff.Start(10000));
