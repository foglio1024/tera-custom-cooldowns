...
namespace TCC.ViewModels
{
    public class TooltipInfo : TSPropertyChanged
    {
        ...
        public bool ShowGrantPowers => WindowManager.ViewModels.Group.AmILeader && WindowManager.ViewModels.Group.Raid && WindowManager.ViewModels.Group.Exists(Name) && Name != Session.Me.Name;
        public bool ShowKick => WindowManager.ViewModels.Group.Exists(Name) && Name != Session.Me.Name;
        public bool ShowDelegateLeader => WindowManager.ViewModels.Group.AmILeader && WindowManager.ViewModels.Group.Exists(Name) && Name != Session.Me.Name;
