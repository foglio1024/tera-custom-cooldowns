...
namespace TCC.ViewModels
{
    public class TooltipInfo : TSPropertyChanged
    {
        ...
        public string PowersLabelText => !WindowManager.ViewModels.GroupVM.HasPowers(Name) ? "Grant invite power" : "Revoke invite power";

        public bool ShowGrantPowers => WindowManager.ViewModels.GroupVM.AmILeader && WindowManager.ViewModels.GroupVM.Raid && WindowManager.ViewModels.GroupVM.Exists(Name) && Name != Game.Me.Name;
        public bool ShowKick => WindowManager.ViewModels.GroupVM.Exists(Name) && Name != Game.Me.Name;
        public bool ShowDelegateLeader => WindowManager.ViewModels.GroupVM.AmILeader && WindowManager.ViewModels.GroupVM.Exists(Name) && Name != Game.Me.Name;
